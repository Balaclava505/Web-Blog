    <?php
      ...
      $content = new content('posts.html'); //new class instance

      $content->set('{HEADER}', $header);
       $content->set('{FOOTER}', $footer);
      $content->set('{main_text_header}', 'Blog');
      $content->set('{sub_text_header}', 'A Blog Theme by Bootstrap');

      $content->outContent('posts.html');
